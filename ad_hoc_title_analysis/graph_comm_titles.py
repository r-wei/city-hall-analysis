#The COMMUNICATIONS documents were more disorganized, so we tried to understand them by creating a graph.
#Put down a vertex for each document. Draw an edge between two vertices if their (cleaned) titles have more than threshhold=5 words in common.
#We had some matplotlib, python2/python3 problems, but in the end, this code worked to draw a graph on Bo's laptop in python3.
...
threshhold = 5 #can play with this parameter
count = [0]*209
title_number = 0
titles_after = []
