#This is a version of title_analysis_phrase further customized to the ORDINANCES matter_type. In particular, we include thematic info occurring at the end of a title after a dash. See title_analysis_phrase for further documentation.
